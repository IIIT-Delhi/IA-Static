# International Admissions - IIITD Delhi 
![logo](https://www.iiitd.ac.in/sites/default/files/images/logo/style2greyscalemid.jpg)

## About this Repository

This repo contains the code for the website of International Admissions IIITD!
...
2. Clone your fork:
    ...
    `git clone https://github.com/<username>/IA-Static.git`
    
    Where `<username>` is your github username.

3. Add the base repository as a remote:
    
    `git remote add upstream https://github.com/IIIT-Delhi/IA-Static.git`
